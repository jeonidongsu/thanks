window.basic = {
    ...
    "link": "https://jeonidongsu.github.io/thanks",
    "kakao": {
        "description": "특별한 날, 소중한 시간을\n함께해주셔서 감사드립니다.",
        "button": "모바일 감사장 보기",
        "img": "https://drive.google.com/u/0/drive-viewer/AKGpihb2nvgdiv-xVcSQldNZkmvzCy1VvbP-5nVef_o5NvK7W5AG09xmzVD3XkFjzawz2UCtecQqMzE6yu6RuBbKkGlxTSJVoITfGAI=s1600-rw-v1"
    },
    "info": {
...
function setText(){
    ...
    if(mode=="d"){
        $("#mode-from").html('<span class="relation mr-5">혼주 </span>\n' +
            ...
            '        </div>');
        window.basic.link="https://jeonidongsu.github.io/thanks?m=d";
        ...
        $("#mode-from").html('<span class="relation mr-5">혼주 </span>\n' +
            ...
            '        </span>');
        window.basic.link="https://jeonidongsu.github.io/thanks?m=j";
        $('#txt-greeting').html(window.basic.info.greeting);
    }else{
